...
# [#](#_2-2-%E9%94%AE%E5%85%A5%E7%BD%91%E5%9D%80%E5%88%B0%E7%BD%91%E9%A1%B5%E6%98%BE%E7%A4%BA-%E6%9C%9F%E9%97%B4%E5%8F%91%E7%94%9F%E4%BA%86%E4%BB%80%E4%B9%88) 2.2 键入网址到网页显示，期间发生了什么？
...
![简单的网络模型](1720194377-878c77f87bbd621d5700727a3b45c332.jpg)

## [#](#%E5%AD%A4%E5%8D%95%E5%B0%8F%E5%BC%9F-http) 孤单小弟 —— HTTP
...
## [#](#%E7%9C%9F%E5%AE%9E%E5%9C%B0%E5%9D%80%E6%9F%A5%E8%AF%A2-dns) 真实地址查询 —— DNS
...
![域名解析的工作流程](1720194377-06f033b3fce0fd58ecc39cdba8827897.jpg)
...
## [#](#%E6%8C%87%E5%8D%97%E5%A5%BD%E5%B8%AE%E6%89%8B-%E5%8D%8F%E8%AE%AE%E6%A0%88) 指南好帮手 —— 协议栈
...
## [#](#%E5%8F%AF%E9%9D%A0%E4%BC%A0%E8%BE%93-tcp) 可靠传输 —— TCP
...
![TCP 连接状态查看](1720194377-2edd0e244ea2782ae6917052f20461e0.jpg)
...
![TCP 层报文](1720194377-13387b2ee36235985ee94a195f7d9857.jpg)

> 此时，遇上了 TCP 的 数据包激动表示：“太好了，碰到了可靠传输的 TCP 传输，它给我加上 TCP 头部，我不再孤单了，安全感十足啊！有大佬可以保护我的可靠送达！但我应该往哪走呢？”

* * *

## [#](#%E8%BF%9C%E7%A8%8B%E5%AE%9A%E4%BD%8D-ip) 远程定位 —— IP
...
![IP 包头格式](1720194377-4ab795111ce9802890e30cc7de455013.jpg)
...
![路由表](1720194377-477cd809eb5f4a0527297f3cecdfae9f.jpg)

举个例子，根据上面的路由表，我们假设 Web 服务器的目标地址是 `192.168.10.200`。

![路由规则判断](1720194377-d1ed1b80962995c284c8b4b1edbd8d1f.jpg)
...
![IP 层报文](1720194377-558e26bba7efa6717a4a8bb00499bb3b.jpg)

> 此时，加上了 IP 头部的数据包表示 ：“有 IP 大佬给我指路了，感谢 IP 层给我加上了 IP 包头，让我有了远程定位的能力！不会害怕在浩瀚的互联网迷茫了！可是目的地好远啊，我下一站应该去哪呢？”

* * *

## [#](#%E4%B8%A4%E7%82%B9%E4%BC%A0%E8%BE%93-mac) 两点传输 —— MAC
...
![MAC 包头格式](1720194377-537f086cd4221c47f048ad82c8edfa19.jpg)
...
![ARP 广播](1720194377-f02ce502a1c9d2b53015bfec95b9aca1.jpg)
...
![ARP 缓存内容](1720194377-fc0f0932cef439e9ff099e925a995eff.jpg)

> MAC 报文生成

至此，网络包的报文如下图。

![MAC 层报文](1720194377-51dcb5c27cfefc705d7357da81d93492.jpg)

> 此时，加上了 MAC 头部的数据包万分感谢，说道 ：“感谢 MAC 大佬，我知道我下一步要去哪了！我现在有很多头部兄弟，相信我可以到达最终的目的地！”。 带着众多头部兄弟的数据包，终于准备要出门了。

* * *

## [#](#%E5%87%BA%E5%8F%A3-%E7%BD%91%E5%8D%A1) 出口 —— 网卡
...
![数据包](1720194377-735fcca6b4066b89eb57b04d6f918bad.png)
...
## [#](#%E9%80%81%E5%88%AB%E8%80%85-%E4%BA%A4%E6%8D%A2%E6%9C%BA) 送别者 —— 交换机
...
![交换机的 MAC 地址表](1720194377-b93bea3e302a35427a3d83fd34804808.jpg)
...
## [#](#%E5%87%BA%E5%A2%83%E5%A4%A7%E9%97%A8-%E8%B7%AF%E7%94%B1%E5%99%A8) 出境大门 —— 路由器
...
![路由器转发](1720194377-661eeaafc074b5330c14bc078d8ce057.jpg)
...
## [#](#%E4%BA%92%E7%9B%B8%E6%89%92%E7%9A%AE-%E6%9C%8D%E5%8A%A1%E5%99%A8-%E4%B8%8E-%E5%AE%A2%E6%88%B7%E7%AB%AF) 互相扒皮 —— 服务器 与 客户端

数据包抵达了服务器，服务器肯定高兴呀，正所谓有朋自远方来，不亦乐乎？

服务器高兴的不得了，于是开始扒数据包的皮！就好像你收到快递，能不兴奋吗？

![网络分层模型](1720194377-4cd9af27b4c96d75684e5430f1ba8090.jpg)
...
## [#](#%E4%B8%80%E4%B8%AA%E6%95%B0%E6%8D%AE%E5%8C%85%E8%87%AD%E4%B8%8D%E8%A6%81%E8%84%B8%E7%9A%84%E6%84%9F%E5%8F%97) 一个数据包臭不要脸的感受
...
## [#](#%E8%AF%BB%E8%80%85%E9%97%AE%E7%AD%94) 读者问答
